...
export default function SkillsCard() {
  return (
    <div className="group flex h-full flex-col rounded-3xl bg-bg-card p-8 shadow-card transition-all duration-500 ease-in-out hover:border hover:border-white/[0.06]">
      {/* Title */}
